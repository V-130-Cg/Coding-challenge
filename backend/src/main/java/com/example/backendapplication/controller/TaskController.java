...
public class TaskController {
    ...
    public ResponseEntity<Task> getTask(@PathVariable UUID id) {
        //Check whether get correct id in LOG
        ...
        try {
            ...
            //Log occur error message
            log.error("An error occurred while getting task: {}", e.getMessage());
    ...
    public ResponseEntity<Boolean> deleteTask(@PathVariable UUID id) {
        try {
            ...
            boolean isDeleted = deletedTask != null;

            return ResponseEntity.ok(isDeleted);
        } catch (Exception e) {
            //Log occur error message
            log.error("An error occurred while deleting task: {}", e.getMessage());
